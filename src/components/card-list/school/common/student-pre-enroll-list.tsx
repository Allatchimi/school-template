...
import StudentPreEnrollCard from "./student-enroll-card";
...
export default function StudentPreEnrollList(
  props: CardListProps<StudentPreEnrollResponse, StudentPreEnrollListResponse>,
) {
  return (
