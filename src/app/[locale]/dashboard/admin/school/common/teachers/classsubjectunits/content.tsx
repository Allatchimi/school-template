...
import FormAddUpdateTeacherClassSubjectUnit from "@/components/form/school/common/form-add-update-teacher-class-subject-unit";
import { TableColumsTeacherClassSubjectUnit } from "@/components/table/columns/school/common/columns-teacher-class-subject-unit";
...
import {
  ...
  compareTeacherClassSubjectUnitRequestToResponse,
...
import {
  getTeacherClassSubjectUnitList,
  postTeacherClassSubjectUnit,
  updateTeacherClassSubjectUnit,
  deleteTeacherClassSubjectUnit,
  deleteMultipleTeacherClassSubjectUnit,
  ...
  return (
    <>
      <ContentTableTemplate<
        ...
        FilterSchoolYearClassLevelDomainType
      >
        itemLabel={tWords("teaching")}
        downloadUploadTableName="teacher_class_subject_units"
        queryKeyData="admin-teacher-class-subject-units-data"
        canAdd={true}
        canUpdate={true}
        canDeleteOne={true}
        ...
        columns={TableColumsTeacherClassSubjectUnit({
          schoolType: SchoolConfig.schoolType(),
          yearID: SchoolConfig.yearID(),
          orderBy: paramOrderBy ?? undefined,
          sort: formatSortStrToSortOrder(paramSort ?? undefined),
        })}
        areEqual={compareTeacherClassSubjectUnitRequestToResponse}
        returnFormAddUpdateNode={FormAddUpdateTeacherClassSubjectUnit}
        returnDescriptions={(item) => {
          return [
            {
              title: tWords("teacher"),
              description: DescriptionTeacher(item?.teacher ?? undefined),
            },
            {
              title: tWords("school"),
        ...
        getItemList={getTeacherClassSubjectUnitList}
        postItem={postTeacherClassSubjectUnit}
        updateItem={updateTeacherClassSubjectUnit}
        deleteItem={deleteTeacherClassSubjectUnit}
        deleteMultipleItems={deleteMultipleTeacherClassSubjectUnit}
