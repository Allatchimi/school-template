...
import { DescriptionReportEntry } from "@/components/description/school/common/description-report-entry";
...
import FormAddUpdateReportEntry from "@/components/form/school/common/form-add-update-report-entry";
import { TableColumsReportEntry } from "@/components/table/columns/school/common/columns-report-entry";
  ...
  return (
    <>
      <ContentTableTemplate<
        ...
        FilterSchoolYearClassLevelDomainType
      >
        itemLabel={tWords("reportEntry")}
        downloadUploadTableName="report_entries"
        queryKeyData="admin-reports-data"
        canAdd={true}
        canUpdate={false}
        canDeleteOne={false}
        ...
        columns={TableColumsReportEntry({
        ...
        areEqual={undefined}
        returnFormAddUpdateNode={FormAddUpdateReportEntry}
        returnDescriptions={(item) => {
          return [
            { description: DescriptionReportEntry(item) },
            {
        ...
        getItemList={getReportEntryList}
        postItem={postReportEntry}
