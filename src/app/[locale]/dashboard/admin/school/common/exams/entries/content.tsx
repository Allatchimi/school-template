...
import FormAddUpdateExam from "@/components/form/school/common/form-add-update-exam";
import { TableColumsExam } from "@/components/table/columns/school/common/columns-exam";
  ...
  return (
    <>
      ...
      >
        ...
        downloadUploadTableName="exams"
        queryKeyData="admin-exams-data"
        canAdd={true}
        canUpdate={true}
        canDeleteOne={true}
        ...
        returnFormAddUpdateNode={FormAddUpdateExam}
        ...
        deleteMultipleItems={deleteMultipleExam}
