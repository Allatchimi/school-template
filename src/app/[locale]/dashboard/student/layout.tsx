...
import { PATH_PROTECTED_STUDENT } from "@/lib/constants/routes";
import StudentSideMenuItems from "./components/student-side-menu-items";
...
export default function Layout({
  ...
  const sideMenuItems = (onClick?: (info: { key: string }) => void) => {
    const menuItems = StudentSideMenuItems({
      schoolType: SchoolConfig.schoolType(),
      basePath: PATH_PROTECTED_STUDENT,
      onClick: onClick,
    });
    return menuItems;
  };
